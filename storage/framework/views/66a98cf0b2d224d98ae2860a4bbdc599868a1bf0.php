...
<section id="section-welcome" class="full-height dark" data-stellar-background-ratio=".2">
    <div class="center-y text-center">
        ...
        <div class="spacer-single"></div>
        <a href="index.html#section-portfolio" class="btn btn-border btn-big">View Our Works</a>
    </div>
            ...
            <div class="feature-box-small-icon box-fx center col-md-3 animated" data-animation="fadeInUp" data-delay="0">
                <div class="inner">
                    ...
                    <div class="info">
                        ...
                        <br>
                        <a href="index.html#" class="btn btn-border">Read More</a>
                    </div>
                </div>
            </div>
            <!-- featured box close -->
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3 text-center">
                        ...
                        <div class="animated" data-animation="fadeInUp">
                            ...
                            <div class="spacer-single"></div>
                            <a href="index.html#" class="btn btn-border" data-animation="fadeIn">Let's Rock!</a>
                        </div>
                    </div>
                </div>
            </div>
...
<section id="section-portfolio" class="no-bottom">
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <ul id="filters" class="animated" data-animation="fadeInUp" data-delay="200">
                    <li><a href="index.html#" data-filter="*" class="selected">show all</a></li>
                    <li><a href="index.html#" data-filter=".illustration">Illustration</a></li>
                    <li><a href="index.html#" data-filter=".mobile">Mobile</a></li>
                    <li><a href="index.html#" data-filter=".photography">Photography</a></li>
                    <li><a href="index.html#" data-filter=".website">Website</a></li>
                </ul>
    ...
    <div id="gallery" class="gallery full-gallery de-gallery pf_full_width animated" data-animation="fadeInUp" data-delay="200">
        ...
        <div class="item illustration">
            <div class="picframe">
                <span class="overlay">
                    <span class="icon">
                        <a href="images/portfolio/pf&#32;(1).jpg" data-type="prettyPhoto[gallery]"><i class="fa fa-search icon-view"></i></a>
                    </span>
                    <span class="icon">
        ...
        <div class="item mobile website">
            <div class="picframe">
                <span class="overlay">
                    <span class="icon">
                        <a href="images/portfolio/pf&#32;(2).jpg" data-type="prettyPhoto[gallery]"><i class="fa fa-search icon-view"></i></a>
    ...
    <div class="item website mobile">
        <div class="picframe">
            <span class="overlay">
                <span class="icon">
                    <a href="images/portfolio/pf&#32;(3).jpg" data-type="prettyPhoto[gallery]"><i class="fa fa-search icon-view"></i></a>
                </span><span class="icon">
...
<div class="item illustration photography">
    <div class="picframe">
        <span class="overlay">
            <span class="icon">
                <a href="images/portfolio/pf&#32;(4).jpg" data-type="prettyPhoto[gallery]"><i class="fa fa-search icon-view"></i></a>
            </span><span class="icon">
...
<div class="item website photography mobile">
    <div class="picframe">
        <span class="overlay">
            <span class="icon">
                <a href="images/portfolio/pf&#32;(5).jpg" data-type="prettyPhoto[gallery]"><i class="fa fa-search icon-view"></i></a>
            </span><span class="icon">
            <i class="fa fa-align-justify fa-external-link icon-info" data-value="project-details-slider.html"></i>
        </span>
        <span class="pf_text">
...
<div class="item illustration website">
    <div class="picframe">
        <span class="overlay">
            <span class="icon">
                <a href="images/portfolio/pf&#32;(6).jpg" data-type="prettyPhoto[gallery]"><i class="fa fa-search icon-view"></i></a>
            </span><span class="icon">
            <i class="fa fa-align-justify fa-external-link icon-info" data-value="project-details-slider-big.html"></i>
        </span>
        <span class="pf_text">
                ...
                <div class="de_testi">
                    ...
                    <div class="de_testi_by">
                        <div class="de_testi_pic">
                            <img src="images/testi_pic&#32;(1).jpg" alt="" class="img-circle">
                        </div>
                ...
                <div class="de_testi">
                    ...
                    <div class="de_testi_by">
                        <span class="de_testi_pic">
                            <img src="images/testi_pic&#32;(2).jpg" alt="" class="img-circle"></span>
                            <div class="de_testi_company">
                ...
                <div class="animated" data-animation="fadeInUp" data-delay="200">
                    <div class="col-md-4 bloglist">
                        <div class="post-content">
                            ...
                            <div class="post-text">
                                <h3><a href="css/index.html#">Best DSLR Camera</a></h3>
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                                <br>
                                <a href="index.html#" class="btn-text">Read More</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 bloglist">
                        <div class="post-content">
                            ...
                            <div class="post-text">
                                <h3><a href="css/index.html#">Playstation 4</a></h3>
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                                <br>
                                <a href="index.html#" class="btn-text">Read More</a>
                            </div>
                    ...
                    <div class="col-md-4 bloglist">
                        <div class="post-content">
                            ...
                            <div class="post-text">
                                <h3><a href="css/index.html#">Photography Tips</a></h3>
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                                <br>
                                <a href="index.html#" class="btn-text">Read More</a>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8 animated" data-animation="fadeInUp" data-delay="200" data-speed="5">
                        ...
                        <form name="contactForm" id='contact_form' method="post" action='http://www.themenesia.com/themeforest/cubic-onepage/email.php'>
                            <div class="row">
                                <div class="col-md-6">
                    ...
                    <div class="col-md-4">
                        <address>
                            ...
                            <span><i class="fa fa-globe fa-lg"></i><a href="index.html#">support.cubic.com</a></span>
                        </address>
                    </div>
                </div>
            </div>
