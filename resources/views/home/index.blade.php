        ...
        <ul>
            <li data-transition="fade" data-slotamount="10" data-masterspeed="200" data-thumb="images-slider/thumbs/thumb1.jpg">
                ...
                <img src="images-slider/miami.jpg" alt="imagen" />
                            ...
                            data-start="800"
                            data-easing="easeInOutExpo">
                            <a href="{{route ('catalogo.index')}}" class="btn-slider">CATÁLAGO
                            </a>
                        </div>
                    </li>
                    ...
                    <li data-transition="fade" data-slotamount="10" data-masterspeed="200" data-thumb="images-slider/thumbs/thumb1.jpg">
                        ...
                        <img src="images-slider/venezuela.jpg" alt="imagen" />
                            ...
                            data-start="800"
                            data-easing="easeInOutExpo">
                            <a href="{{route ('catalogo.index')}}" class="btn-slider">CATÁLOGO
                            </a>
                        </div>
                    </li>
                            ...
                            <div class="row">
                              <div class="col-sm-3">
                                ...
                                <div class="ih-item circle effect2 left_to_right"><a href="#">
                                    ...
                                    <div class="info">
                                      <h3>{{$contenido[0]->str_titulo}}</h3>
                                      <p>{!! $contenido[0]->str_descripcion !!}</p>
                                  </div></a></div>
                                  <!-- end normal -->
                              ...
                              <div class="col-sm-3">
                                ...
                                <div class="ih-item circle effect2 left_to_right"><a href="#">
                                    ...
                                    <div class="info">
                                      <h3>{{$contenido[1]->str_titulo}}</h3>
                                      <p>{!! $contenido[1]->str_descripcion !!}</p>
                                  </div></a></div>
                                  <!-- end normal -->
                              ...
                              <div class="col-sm-3">
                                ...
                                <div class="ih-item circle effect2 left_to_right"><a href="#">
                                    ...
                                    <div class="info">
                                      <h3>{{$contenido[2]->str_titulo}}</h3>
                                      <p>{!! $contenido[2]->str_descripcion !!}</p>
                                  </div></a></div>
                                  <!-- end normal -->
                              ...
                              <div class="col-sm-3">
                                ...
                                <div class="ih-item circle effect2 left_to_right"><a href="#">
                                    ...
                                    <div class="info">
                                      <h3>{{$contenido[3]->str_titulo}}</h3>
                                      <p>{!! $contenido[3]->str_descripcion !!}</p>
                                  </div></a></div>
                                  <!-- end normal -->
                    ...
                    <div class='row'>
                        <div class='col-md-12'>
                            <div class="carousel" data-flickity='{ "cellAlign": "left", "contain": true }' >
                               ...
                               <div class="carousel-cell grow" onclick="redireccion('/Informacion/{{$pr->id}}')" style="margin-right: 10px; cursor: pointer;" >
                                 <img  src="{{$pr->str_urlimage}}" alt="imagen" height="230" width="230" style="">
                                 <br>
                                 <center>{{$pr->str_nombre}}</center>
                             </div>
                             @endforeach
                         </div>
                     </div>
                ...
                <div class="row">
                 <div class="col-sm-4">
                    ...
                    <div class="ih-item square effect14 left_to_right"><a>
                        <div class="img" style="margin-left:25%; margin-top:10%"><img src="{{url('images/mante.png')}}" style="width: 60%" alt="imagen"><h3 style="margin-left: -18%">{{$contenido[4]->str_titulo}}</h3></div>
                        <div class="info">
                          <h3>{{$contenido[4]->str_titulo}}</h3>
                          {!! $contenido[4]->str_descripcion !!}
                      </div></a></div>
                      <!-- end normal -->
                  ...
                  <div class="col-sm-4">
                    ...
                    <!-- normal -->
                    <div class="ih-item square effect14 left_to_right"><a>
                        <div class="img" style="margin-left:25%; margin-top:10%"><img src="{{url('images/capacitacion.png')}}" style="width: 60%" alt="imagen"><h3>{{$contenido[5]->str_titulo}}</h3></div>
                        <div class="info">
                          <h3 style="margin-top:1px">{{$contenido[5]->str_titulo}}</h3>
                          {!! $contenido[5]->str_descripcion !!}
                      </div></a></div>
                      <!-- end normal -->
                  ...
                  <div class="col-sm-4">
                    ...
                    <!-- normal -->
                    <div class="ih-item square effect14 left_to_right"><a>
                        <div class="img" style="margin-left:25%; margin-top:10%"><img src="{{url('images/soporte.png')}}" style="width: 60%" alt="imagen"><h3 style="margin-left: 14%">{{$contenido[6]->str_titulo}}</h3></div>
                        <div class="info">
                          <h3>{{$contenido[6]->str_titulo}}</h3>
                          {!! $contenido[6]->str_descripcion !!}
                      </div></a></div>
                      <!-- end normal -->
            ...
            <div class="row">
                ...
                <div class="col-md-4 animated" data-animation="fadeInLeft" data-delay="100">
                    <div class="de_count" id="zoom">
                        ...
                        <h3 class="timer" data-to="433" data-speed="2500">0</h3>
                ...
                <div class="col-md-4 animated" data-animation="fadeInLeft" data-delay="0" >
                    <div class="de_count"  id="zoom">
                        ...
                        <h3 class="timer" data-to="702" data-speed="2500">0</h3>
                        <span>Twetts</span>
                    </div>
                </div>
                ...
                <div class="col-md-4 animated" data-animation="fadeInRight" data-delay="0">
                    <div class="de_count"  id="zoom">
                        ...
                        <h3 class="timer" data-to="590" data-speed="2500">0</h3>
                        <span>Posts</span>
                    </div>
                </div>
                            ...
                            <div class="row">
                              <div class="col-sm-3">
                                ...
                                <div class="ih-item circle effect2 left_to_right"><a href="#">
                                    ...
                                    <div class="info">
                                      <h3></h3>
                                      <p>{!! $contenido[14]->str_descripcion !!}</p>
                                  </div></a></div>
                                  <!-- end normal -->
                              ...
                              <div class="col-sm-3">
                                ...
                                <div class="ih-item circle effect2 left_to_right"><a href="#">
                                    ...
                                    <div class="info">
                                      <h3></h3>
                                      <p>{!! $contenido[11]->str_descripcion !!}</p>
                                  </div></a></div>
                                  <!-- end normal -->
                              ...
                              <div class="col-sm-3">
                                ...
                                <div class="ih-item circle effect2 left_to_right"><a href="#">
                                    ...
                                    <div class="info">
                                      <h3></h3>
                                      <p>{!! $contenido[12]->str_descripcion !!}</p>
                                  </div></a></div>
                                  <!-- end normal -->
                               ...
                               <div class="col-sm-3">
                                ...
                                <!-- normal -->
                                  ...
                                  <div class="ih-item circle effect2 left_to_right"><a href="http://bluproducts.com.es/">
                                    ...
                                    <div class="info">
                                      <h3></h3>
                                      <p>{!! $contenido[13]->str_descripcion !!}</p>
                                  </div></a></div>
                                  <!-- end normal -->
                                  <!-- end normal -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 animated" data-animation="fadeInUp" data-delay="200" data-speed="5">
                    ...
                    <form name="contactForm" id='contact_form' method="post" action="{{route('home.correo')}}">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div>
                                    <select name='pais' id='pais' class="form-control inputs">
                                        ...
                                        @foreach ($paises as $lugar)
                                        <option value="{{$lugar->str_value}}">{{$lugar->str_options}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div>
                                    <input type="hidden" name="pais_cl" value="{{$pais}}">
                ...
                <div class="col-md-4">
                    ...
                    <address>
                        ...
                        <span><i class="fa fa-clock-o fa-lg"></i>{!! $contenido[10]->str_titulo !!}: {!! $contenido[10]->str_descripcion !!}</a></span>
                    </address>

                    @else
                    <address>
                        <span><i class="fa fa-map-marker fa-lg"></i>{!! $contenido[7]->str_descripcion !!}</span>
                        <span><i class="fa fa-phone fa-lg"></i>{!! $contenido[8]->str_descripcion !!}</span>
                        <span><i class="fa fa-envelope-o fa-lg"></i><a href="mailto:info@tecnotropolisla.com">{!! $contenido[9]->str_descripcion !!}</a></span>
                        <span><i class="fa fa-clock-o fa-lg"></i>{!! $contenido[10]->str_titulo !!}: {!! $contenido[10]->str_descripcion !!}</a></span>
                    </address>
                    @endif
                </div>
